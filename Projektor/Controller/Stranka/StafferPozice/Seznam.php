<?php
class Projektor_Controller_Stranka_StaferPozice_Seznam extends Projektor_Controller_Stranka_Seznam
{
    nemám databázi!
...
//        const NAZEV_DATOVEHO_OBJEKTU_MNOZNE = "Firmy";
    ...
    public function potomekNeni()
    {
        ...
        $tlacitka = array
        (
            new Projektor_Controller_Stranka_Element_Tlacitko("Nová firma", $this->uzel->potomekUri("Projektor_Controller_Stranka_Firma_Detail"))
        );
...
/* ------------------------------------------------------------------------------------ */
    ...
    protected function generujTlacitkaProSeznam($firma)
    {
        $tlacitka = array
            (
                    new Projektor_Controller_Stranka_Element_Tlacitko("Detail", $this->uzel->potomekUri("Projektor_Controller_Stranka_Firma_Menu", array("id" => $firma->id, "zmraz" => 1)), "tlacitko"),
            );
        return $tlacitka;
    }
