 ...
 * @author pes2704
 */
abstract class Projektor_Controller_Stranka_Detail extends Projektor_Controller_Stranka_Base
{
	...
	public function vychozi()
	{
            ...
            $form = new HTML_QuickForm("objekt", "post", $this->uzel->formActionUri());
            $tridaItem = static::TRIDA_DATA_ITEM;
            ...
            if (is_subclass_of($item, "Projektor_Data_HlavniObjektItem")) //$item je hlavní objekt = $item je potomek Projektor_Data_HlavniObjektItem
            {
                ...
                $elementy = $this->pripravElementyFormulareZFlatTableObjektu($itemObjektVlastnost, $tridaItem);
                ...
                $elementy = $this->pripravElementyFormulareZFlatTableObjektu($item);
...
//		return $this->vytvorStranku("detail", self::SABLONA_DETAIL, $this->uzel->parametry, $form->toHtml());
    ...
    /**
        ...
        * @return type
        */
    protected function pripravElementyFormulareZFlatTableObjektu(Projektor_Data_Item $item, $nazevHlavnihoObjektu = NULL)
    {
