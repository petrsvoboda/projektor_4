<?php
class Projektor_Controller_Stranka_TypAkce_Seznam extends Projektor_Controller_Stranka_Seznam
{
    ...
    public function potomekNeni()
    {
        ...
        $tlacitka = array
        (
            new Projektor_Controller_Stranka_Element_Tlacitko("Nový typ akce", $this->uzel->potomekUri("Projektor_Controller_Stranka_TypAkce_Detail"))
        );
        $this->novaPromenna("tlacitka", $tlacitka);
    }

    public function potomek°Projektor_Controller_Stranka_TypAkce_Menu()
    {
        /* Nadpis stranky */
...
/* ------------------------------------------------------------------------------------ */
    protected function generujTlacitkaProSeznam($typAkce)
    {
        $tlacitka = array
            (
                    new Projektor_Controller_Stranka_Element_Tlacitko("Detail", $this->uzel->potomekUri("Projektor_Controller_Stranka_TypAkce_Menu", array("id" => $typAkce->id, "zmraz" => 1)), "tlacitko"),
            );
        return $tlacitka;
    }
