<?php
class Projektor_Controller_Stranka_Zajemce_Seznam_Prihlasovaci extends Projektor_Controller_Stranka_Zajemce_Seznam
{
    ...
    protected function potomek°Projektor_Controller_Stranka_Zajemce_Menu(Projektor_Controller_Uzel $uzelPotomek = null)
    {
        $this->generujPolozku($uzelPotomek);
        /* Nadpis stranky */
        $this->novaPromenna("nadpis", "Zájemce  - zobrazení a úprava vlastností");
    }
    protected function potomek°Projektor_Controller_Stranka_Zajemce_Prihlaska(Projektor_Controller_Uzel $uzelPotomek = null)
    {
    ...
    protected function generujTlacitkaProSeznam($zajemce)
    {
        $tlacitka = array
            (
                ...
                new Projektor_Controller_Stranka_Element_Tlacitko("Přihlaš na akci", $this->uzel->potomekUri("Projektor_Controller_Stranka_Zajemce_Prihlaska", array("id" => $zajemce->id)), "tlacitko"),
            );
        return $tlacitka;
    }
