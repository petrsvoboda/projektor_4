<?php
class Projektor_Controller_Stranka_Zajemce_Seznam extends Projektor_Controller_Stranka_Seznam
{
    ...
    protected function potomekNeni()
    {
        ...
        $tlacitka = array
        (
            new Projektor_Controller_Stranka_Element_Tlacitko("Nový zájemce", $this->uzel->potomekUri("Projektor_Controller_Stranka_Zajemce_Detail", array("objektVlastnost" => "smlouva")))
        );
        $this->novaPromenna("tlacitka", $tlacitka);
    }

    protected function potomek°Projektor_Controller_Stranka_Zajemce_Menu()
    {
        /* Nadpis stranky */
        $this->novaPromenna("nadpis", "Zájemce vybraný ze seznamu");
    }

    protected function potomek°Projektor_Controller_Stranka_AkceM_AkceObjektu()
    {
        /* Nadpis stranky */
        $this->novaPromenna("nadpis", "Akce zájemce");
    }

    protected function potomek°Projektor_Controller_Stranka_AkceM_Prihlasovaci()
    {
        /* Nadpis stranky */
        $this->novaPromenna("nadpis", "Přihlášení zájemce na akci");
    }

    public function potomek°Projektor_Controller_Stranka_Zajemce_Smaz()
    {
...
/* ------------------------------------------------------------------------------------ */
    ...
    protected function generujTlacitkaProSeznam($zajemce)
    {
        $tlacitka = array
            (
                    new Projektor_Controller_Stranka_Element_Tlacitko("Detail", $this->uzel->potomekUri("Projektor_Controller_Stranka_Zajemce_Menu", array("id" => $zajemce->id, "zmraz" => 1)), "tlacitko"),
            );
        return $tlacitka;
    }
