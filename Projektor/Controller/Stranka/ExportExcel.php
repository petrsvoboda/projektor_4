<?php
class Projektor_Controller_Stranka_ExportExcel extends Projektor_Controller_Stranka_Base implements Projektor_Controller_Stranka_Interface
{
	...
	protected function main°potomekNeni()
	{
		...
		(
			...
			new Projektor_Controller_Stranka_Element_Tlacitko("Export do Excelu", $this->cesta->potomekUri("Projektor_Controller_Stranka_ExportExcel"))		);
                $this->novaPromenna("tlacitka", $tlacitka);
        }

	protected function main°potomek°Projektor_Controller_Stranka_ExportExcel°exportExcel()
	{
