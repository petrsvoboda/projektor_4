...
class Projektor_Controller_Stranka_Element_Select
{
	private $form;
	private $elementGrid;
	private $sloupce;
	 ...
	 */
	public function __construct(HTML_QuickForm2 $form, Projektor_Data_Collection $collection, $zobrazovanaVlastnost, $nazev, $popisek)
	{
		$this->form = $form;
                $poleSelect[""] = "";
