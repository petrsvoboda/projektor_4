...
class Projektor_Controller_Stranka_Element_Hierselect
{
	private $form;
	private $elementGrid;
	private $sloupce;
	 ...
	 */
	public function __construct(HTML_QuickForm2 $form, $collectionLevel1, $collectionLevel1, $nazev, $popisek)
	{
		$this->form = $form;
	...
	private function pridejRadky()
	{
		...
		{
			$radek[] = HTML_QuickForm2_Factory::createElement($this->typ, $this->nazev, "", $radekDat->id);
			foreach($this->sloupce as $nazev => $popis)
				$radek[] = HTML_QuickForm2_Factory::createElement(Projektor_Controller_Stranka_Element_BlokRadioButton::STATICKY_ELEMENT, "", $radekDat->$nazev);
