...
class Projektor_Controller_Stranka_Element_BlokRadioButton
{
	private $form;
	private $elementGrid;
	private $sloupce;
	...
	private function pridejRadky()
	{
		...
		foreach($this->collection as $radekDat)
		{
			...
			foreach($this->sloupce as $nazev => $popis)
				$radek[] = HTML_QuickForm::createElement(Projektor_Controller_Stranka_Element_BlokRadioButton::STATICKY_ELEMENT, "", "", $radekDat->$nazev);
