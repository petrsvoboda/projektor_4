 ...
 * @author Marek Petko
 */
class Projektor_Controller_Stranka_Element_Filtr
{
    public $pravidla;
    ...
    {
        $filtr = new Projektor_Controller_Stranka_Element_Filtr();
        foreach($sloupceHodnoty as $sloupec => $hodnota)
            if($hodnota)
                $filtr->pravidla[] = new Projektor_Controller_Stranka_Element_Filtr_Pravidlo($sloupec, Projektor_Controller_Stranka_Element_Filtr::EQUALS, $hodnota);
    ...
    public static function like($sloupceHodnoty = NULL)
    {
        ...
        if ($sloupceHodnoty) {
            foreach($sloupceHodnoty as $sloupec => $hodnota)
            if($hodnota)
                $filtr->pravidla[] = new Projektor_Controller_Stranka_Element_Filtr_Pravidlo($sloupec, Projektor_Controller_Stranka_Element_Filtr::LIKE, $hodnota, true, true);            
        }
