...
class Projektor_Controller_Stranka_Generator
{
    public $uzel;
    public  $stranka;
    ...
    /**
     * Konstanty pro třídy Projektor_Controller_Stranka
     */
    ...
    public function __construct(Projektor_Controller_Uzel $uzel) {
        $this->uzel = $uzel;
    }
    ...
    public function volejMetoduPotomkovskou(Projektor_Controller_Stranka_Base $strankaPotomek = null)
