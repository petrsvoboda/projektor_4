<?php
class Projektor_Controller_Stranka_Predpoklad_Seznam extends Projektor_Controller_Stranka_Seznam
{
    ...
    public function potomekNeni()
    {
        ...
        $tlacitka = array
        (
            new Projektor_Controller_Stranka_Element_Tlacitko("Nový předpoklad", $this->uzel->potomekUri("Projektor_Controller_Stranka_Predpoklad_Detail"))
        );
        $this->novaPromenna("tlacitka", $tlacitka);
    }

    public function potomek°Projektor_Controller_Stranka_Predpoklad_Menu()
    {
        /* Nadpis stranky */
...
/* ------------------------------------------------------------------------------------ */
    protected function generujTlacitkaProSeznam($predpoklad)
    {
        $tlacitka = array
            (
                    new Projektor_Controller_Stranka_Element_Tlacitko("Detail", $this->uzel->potomekUri("Projektor_Controller_Stranka_Predpoklad_Menu", array("id" => $predpoklad->id, "zmraz" => 1)), "tlacitko"),
            );
        return $tlacitka;
    }
	...
	protected function proTypAkce°vzdy()
	{
            ...
            (
                ...
                //TODO: tohle určitě nefunguje pro typ akce
                    new Projektor_Controller_Stranka_Element_Tlacitko("Nový předpoklad", $this->uzel->potomekUri("Projektor_Controller_Stranka_Predpoklad")),
            );
            $this->novaPromenna("tlacitka", $tlacitka);
	}
