 <?php
class Projektor_Controller_Stranka_Ucastnik extends Projektor_Controller_Stranka_Base implements Projektor_Controller_Stranka_Interface
{
	...
	public function detail($parametry = null)
	{
		...
		$form = new HTML_QuickForm("ucastnik", "post", $this->cesta->formActionUri());
