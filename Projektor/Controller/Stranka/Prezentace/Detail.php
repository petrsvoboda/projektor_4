<?php
class Projektor_Controller_Stranka_PrezentaceJ_Menu_Detail extends Projektor_Controller_Stranka_Base implements Projektor_Controller_Stranka_Interface
{
	public function detail()
	{
		/* Konstrukce objektu */
		$form = new HTML_QuickForm2("prezentacej");
