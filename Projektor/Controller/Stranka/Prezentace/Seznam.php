<?php
class Projektor_Controller_Stranka_Prezentace_Seznam extends Projektor_Controller_Stranka_Seznam
{
    ...
    public function potomekNeni()
    {
        ...
        $tlacitka = array
        (
            new Projektor_Controller_Stranka_Element_Tlacitko("Nová prezentace", $this->uzel->potomekUri("Projektor_Controller_Stranka_Prezentace_Detail"))
        );
        $this->novaPromenna("tlacitka", $tlacitka);
    }

    public function potomek°Projektor_Controller_Stranka_Firma_Menu()
    {
        /* Nadpis stranky */
...
/* ------------------------------------------------------------------------------------ */
    ...
    protected function generujTlacitkaProSeznam($prezentace)
    {
        $tlacitka = array
            (
                new Projektor_Controller_Stranka_Element_Tlacitko("Detail", $this->uzel->potomekUri("Projektor_Controller_Stranka_Prezentace_Menu", array("id" => $prezentace->id, "zmraz" => 1)), "tlacitko"),
                new Projektor_Controller_Stranka_Element_Tlacitko("Duplikuj", $this->uzel->potomekUri("Projektor_Controller_Stranka_Prezentace_Menu", array("id" => $prezentace->id, "duplikuj" => 1))),
              );
        return $tlacitka;
    }
