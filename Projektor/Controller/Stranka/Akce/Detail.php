<?php
class Projektor_Controller_Stranka_Akce_Detail extends Projektor_Controller_Stranka_Detail
{
	...
	{
		/* Konstrukce objektu */
		$form = new HTML_QuickForm2("akcej");
...
//);
		...
		/* akcej_idSStavAkceFK */
		$stavAkce = new Projektor_Controller_Stranka_Element_BlokRadioButton($form, new Projektor_Data_Auto_SStavAkceCollection(), "dbField°id_s_stav_akce_FK", "Stav akce");
		$stavAkce->nastavSloupce(array("text" => "Stav", "plnyText" => "Popis"));

		/* akcej_idSTypAkce */
		$typAkce = new Projektor_Controller_Stranka_Element_BlokRadioButton($form, new Projektor_Data_Auto_STypAkceCollection(), "dbField°id_s_typ_akce_FK", "Typ akce");
