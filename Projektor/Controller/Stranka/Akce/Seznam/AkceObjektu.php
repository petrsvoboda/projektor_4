<?php
class Projektor_Controller_Stranka_Akce_Seznam_AkceObjektu extends Projektor_Controller_Stranka_Akce_Seznam
{
	...
	protected function potomekNeni()
	{
        ...
        protected function potomek°Projektor_Controller_Stranka_Ucastnici_Prihlaseni()
        {
        }

        protected function potomek°Projektor_Controller_Stranka_Zajemci_Prihlaseni()
        {
                /* Nadpis stranky */
