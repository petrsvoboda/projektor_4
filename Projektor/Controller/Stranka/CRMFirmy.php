<?php
class Projektor_Controller_Stranka_CRMFirmy extends Projektor_Controller_Stranka_FlatTable_Seznam
{
	...
	public function main()
	{
        ...
        public function main°potomek°Projektor_Controller_Stranka_Firma°detail(Projektor_Controller_Uzel $uzelPotomek = null)
        {
            //použij univrzální metodu třídy FlatTableM pro potomky Projektor_Controller_Stranka_FlatTableJ°detail
            parent::main°potomek°Projektor_Controller_Stranka_FlatTableJ°detail($uzelPotomek);
        }
