...
class Projektor_Data_Seznam_SPrechodAkce extends Projektor_Data_Item
{
	public $id;
	public $text;
	public $plnyText;
	...
	public static function najdiPodleId($id)
	{
		...
		return new Projektor_Data_Seznam_SPrechodAkce($radek[self::TEXT], $radek[self::PLNY_TEXT],
	 ...
	 * @param Projektor_Data_Seznam_SStavAkce $stavPred Stav Akce pred prechodem, tj.soucasny stav.
	 * @param Projektor_Data_Seznam_SStavAkce $stavPo Stav Akce po prechodu, tj budouci stav.
