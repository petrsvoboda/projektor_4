...
/*$akceDen = AkceDen::najdiPodleId(4);
 ...
 $stav = Projektor_Data_Seznam_SStavUcastnikAkceDen::najdiPodleId(7);
 $akceDen->prihlas($ucastnik, $stav);*/

/*$akceDen = AkceDen::najdiPodleId(4);
 $ucastnik = UcastnikB::najdiPodleId(22);
 print_r($akceDen->stavUcastnika($ucastnik));
 $akceDen->zmenStavUcastnika($ucastnik, Projektor_Data_Seznam_SStavUcastnikAkceDen::najdiPodleId(3));*/
